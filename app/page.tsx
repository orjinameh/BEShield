  ...
  return (
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .nav {
          ...
          padding: 14px 40px; border-bottom: 1px solid #f0f0f0;
        ...
        .hero-card {
          width: 320px; flex-shrink: 0; border: 1px solid #e5e5e5;
        ...
        .stellar-log {
          width: 300px; flex-shrink: 0; background: #0f1117;
        ...
        @media (max-width: 768px) {
          ...
          .nodes-grid { grid-template-columns: repeat(2,1fr); gap: 10px; }
          .nodes-grid > div:last-child { grid-column: 1 / -1; max-width: 50%; margin: 0 auto; }

          .stellar-inner { flex-direction: column; gap: 32px; }
          .stellar-log { width: 100%; }
      ...
      <div style={{ color: "#111", background: "#fff" }}>
        ...
        {/* HERO */}
        <section id="hero" style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 40px 60px" }} className="section-pad">
          <div className="hero-inner">
            <div style={{ flex: 1, minWidth: 0 }}>
              <h1 style={{ fontSize: 46, fontWeight: 800, lineHeight: 1.1, letterSpacing: "-1.5px", marginBottom: 20 }}>
                Stop Business<br />
                Email Compromise<br />
                with <span style={{ color: "#00bcd4" }}>AI</span><br />
        ...
        <section style={{ borderTop: "1px solid #f0f0f0", borderBottom: "1px solid #f0f0f0", background: "#fff" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "28px 40px" }} className="section-pad">
        ...
        {/* THE CRISIS OF TRUST */}
        <section id="problem" style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 40px" }} className="section-pad">
          ...
          <div className="crisis-grid">
            {[
              { icon: <Lock size={20} color="#111" />, title: "Single-Point Trust", desc: "Traditional approaches rely on a single person or automated rule, creating a catastrophic point of failure if compromised." },
              { icon: <Layers size={20} color="#111" />, title: "Siloed Intelligence", desc: "Fraud checks often happen in isolation, missing the holistic pattern of a sophisticated multi-stage phishing attack." },
              { icon: <Users size={20} color="#111" />, title: "Human Vulnerability", desc: "Even trained approvers can be social-engineered. BEShield removes the emotional variable from the high-stakes decision path." },
            ].map((item, i) => (
              <div key={i} style={{ border: "1px solid #bbbbbb60", borderRadius: 12, background: "#fff", padding: "24px" }}>
        ...
        <section id="architecture" style={{ background: "#fafafa", borderTop: "1px solid #f0f0f0", borderBottom: "1px solid #f0f0f0" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 40px" }} className="section-pad">
            ...
            <div style={{ maxWidth: 700, margin: "0 auto" }}>
              ...
              {/* Bottom row */}
              <div style={{ marginTop: 20, display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
        ...
        <section id="stellar" style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 40px" }} className="section-pad">
          <div className="stellar-inner">
            <div style={{ flex: 1 }}>
              <h2 style={{ fontSize: 28, fontWeight: 800, letterSpacing: "-0.8px", marginBottom: 12 }}>
                Why Stellar Attestation?
              </h2>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                {[
                  { icon: <Lock size={16} color="#00bcd4" />, title: "Immutable Audit Trails", desc: "Decisions cannot be retroactively altered by attackers or internal bad actors." },
                  { icon: <Zap size={16} color="#00bcd4" />, title: "Lightning Fast Finality", desc: "Transactions settle in seconds, matching the speed of modern business workflows." },
                  { icon: <TrendingUp size={16} color="#00bcd4" />, title: "Low Operational Cost", desc: "Stellar's low transaction fees make high-volume attestation economically viable." },
                ].map((item, i) => (
            ...
            <div className="stellar-log">
              <div style={{ marginBottom: 12, display: "flex", alignItems: "center", gap: 8 }}>
                <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#22c55e" }} />
                <span style={{ fontSize: 11, fontWeight: 600, color: "#aaa", letterSpacing: "0.5px" }}>BT-BLOCKCHAIN-LOG.291</span>
              </div>
        ...
        <section id="research" style={{ background: "#fafafa", borderTop: "1px solid #f0f0f0", borderBottom: "1px solid #f0f0f0" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 40px" }} className="section-pad">
            <div className="research-grid">
              ...
              <div>
                <h2 style={{ fontSize: 22, fontWeight: 800, letterSpacing: "-0.5px", marginBottom: 24 }}>Scientific Foundation</h2>
                <div style={{ border: "1px solid #e5e5e5", borderRadius: 12, padding: "20px", background: "#fff", display: "flex", gap: 14 }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                      <a href="https://zenodo.org/records/20577665" target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 12, fontWeight: 600, color: "#555", background: "none", border: "1px solid #e5e5e5", borderRadius: 6, padding: "6px 12px", textDecoration: "none" }}>
                        <ExternalLink size={12} /> View DOI Publication
                      </a>
                      <a href="https://zenodo.org/records/20577665/files/research%20paper.pdf?download=1" download style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 12, fontWeight: 600, color: "#555", background: "none", border: "1px solid #e5e5e5", borderRadius: 6, padding: "6px 12px", textDecoration: "none" }}>
              ...
              {/* Led by Innovation */}
              <div>
                <h2 style={{ fontSize: 22, fontWeight: 800, letterSpacing: "-0.5px", marginBottom: 24 }}>Led by Innovation</h2>
                <div style={{ border: "1px solid #e5e5e5", borderRadius: 12, padding: "20px", background: "#fff", display: "flex", gap: 14 }}>
                  <div style={{ width: 48, height: 48, background: "#f5f5f5", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: "flex", gap: 10 }}>
                      <a href="https://www.linkedin.com/in/peter-stephen-87784b231/" target="_blank" rel="noopener noreferrer" style={{ width: 28, height: 28, background: "#f5f5f5", borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none" }}>
                      ...
                      <a href="https://x.com/OrjinamehOla" target="_blank" rel="noopener noreferrer" style={{ width: 28, height: 28, background: "#f5f5f5", borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none" }}>
        ...
        <section id="get-started" style={{ background: "#fff" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 40px", textAlign: "center" }} className="section-pad">
            ...
            <div className="cta-row">
              <a href="mailto:peterstephen22000@gmail.com" style={{ background: "#00bcd4", color: "#fff", padding: "12px 28px", borderRadius: 8, fontSize: 14, fontWeight: 700, textDecoration: "none" }}>
                Get Started
              </a>
              <a href="mailto:peterstephen22000@gmail.com?subject=Demo%20Request" style={{ background: "#fff", color: "#111", padding: "12px 28px", borderRadius: 8, fontSize: 14, fontWeight: 600, border: "1px solid #e5e5e5", textDecoration: "none" }}>
                Schedule Demo
              </a>
            </div>
          </div>
        ...
        <footer style={{ background: "#fafafa", borderTop: "1px solid #f0f0f0" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "48px 40px 32px" }} className="section-pad">
            <div className="footer-grid">
              <div>
                <a href="#hero" style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12, textDecoration: "none" }}>
                  <div style={{ width: 24, height: 24, background: "linear-gradient(135deg,#00bcd4,#0097a7)", borderRadius: 5, display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <div>
                ...
                {[
                  ...
                  <div key={item.label} style={{ fontSize: 12, color: "#666", marginBottom: 10 }}>
                    <a href={item.href} target={item.href.startsWith("http") ? "_blank" : undefined} rel={item.href.startsWith("http") ? "noopener noreferrer" : undefined} style={{ color: "#666", textDecoration: "none" }}>
                      {item.label}
                    </a>
                  </div>
                ))}
              ...
              <div>
                ...
                <a href="mailto:peterstephen22000@gmail.com" style={{ fontSize: 12, color: "#666", display: "flex", alignItems: "center", gap: 6, marginBottom: 8, textDecoration: "none" }}>
                  <Mail size={12} /> peterstephen22000@gmail.com
                </a>
                <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
                  <a href="https://www.linkedin.com/in/peter-stephen-87784b231/" target="_blank" rel="noopener noreferrer" style={{ width: 28, height: 28, background: "#fff", border: "1px solid #e5e5e5", borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none" }}>
                  ...
                  <a href="https://x.com/OrjinamehOla" target="_blank" rel="noopener noreferrer" style={{ width: 28, height: 28, background: "#fff", border: "1px solid #e5e5e5", borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none" }}>
